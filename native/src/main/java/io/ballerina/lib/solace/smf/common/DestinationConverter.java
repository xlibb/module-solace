...
import static io.ballerina.lib.solace.smf.common.MessageFieldConstants.QUEUE_NAME_KEY;
import static io.ballerina.lib.solace.smf.common.MessageFieldConstants.TOPIC_NAME_KEY;
...
public class DestinationConverter {
    ...
    public static Destination fromDestinationInterface(
        ...
        return switch (destination) {
            ...
            case io.ballerina.lib.solace.smf.producer.Topic(String topicName) ->
                    JCSMPFactory.onlyInstance().createTopic(topicName);
            case io.ballerina.lib.solace.smf.producer.Queue(String queueName) ->
