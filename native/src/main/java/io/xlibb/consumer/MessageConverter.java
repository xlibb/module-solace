...
import io.xlibb.ModuleUtils;
import io.xlibb.common.DestinationConverter;
import io.xlibb.common.PropertyConverter;

import java.nio.charset.StandardCharsets;

import static io.xlibb.common.Constants.NATIVE_MESSAGE;
import static io.xlibb.common.MessageFieldConstants.APPLICATION_MESSAGE_ID_KEY;
import static io.xlibb.common.MessageFieldConstants.APPLICATION_MESSAGE_TYPE_KEY;
import static io.xlibb.common.MessageFieldConstants.CORRELATION_ID_KEY;
import static io.xlibb.common.MessageFieldConstants.DELIVERY_COUNT_KEY;
import static io.xlibb.common.MessageFieldConstants.DELIVERY_MODE_KEY;
import static io.xlibb.common.MessageFieldConstants.PAYLOAD_KEY;
import static io.xlibb.common.MessageFieldConstants.PRIORITY_KEY;
import static io.xlibb.common.MessageFieldConstants.PROPERTIES_KEY;
import static io.xlibb.common.MessageFieldConstants.RECEIVE_TIMESTAMP_KEY;
import static io.xlibb.common.MessageFieldConstants.REDELIVERED_KEY;
import static io.xlibb.common.MessageFieldConstants.REPLY_TO_KEY;
import static io.xlibb.common.MessageFieldConstants.SENDER_ID_KEY;
import static io.xlibb.common.MessageFieldConstants.SENDER_TIMESTAMP_KEY;
import static io.xlibb.common.MessageFieldConstants.SEQUENCE_NUMBER_KEY;
import static io.xlibb.common.MessageFieldConstants.TIME_TO_LIVE_KEY;
import static io.xlibb.common.MessageFieldConstants.USER_DATA_KEY;
