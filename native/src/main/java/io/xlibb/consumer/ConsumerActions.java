...
import io.xlibb.common.CommonUtils;
import io.xlibb.config.ConfigurationUtils;
import io.xlibb.config.ConsumerConfiguration;
import io.xlibb.config.ConsumerSubscriptionConfig;
import io.xlibb.config.QueueConsumerConfig;
import io.xlibb.config.TopicConsumerConfig;

import java.math.BigDecimal;

import static io.xlibb.common.Constants.NATIVE_CLOSED;
import static io.xlibb.common.Constants.NATIVE_CONSUMER;
import static io.xlibb.common.Constants.NATIVE_FLOW;
import static io.xlibb.common.Constants.NATIVE_SESSION;
import static io.xlibb.common.Constants.NATIVE_SUBSCRIPTION_TYPE;
import static io.xlibb.common.Constants.NATIVE_TRANSACTED;
import static io.xlibb.common.Constants.NATIVE_TX_SESSION;
import static io.xlibb.consumer.ConsumerUtils.SUBSCRIPTION_TYPE_DIRECT_TOPIC;
import static io.xlibb.consumer.ConsumerUtils.SUBSCRIPTION_TYPE_DURABLE_TOPIC;
import static io.xlibb.consumer.ConsumerUtils.SUBSCRIPTION_TYPE_QUEUE;
import static io.xlibb.consumer.ConsumerUtils.createDirectTopicConsumer;
import static io.xlibb.consumer.ConsumerUtils.createDurableTopicConsumer;
import static io.xlibb.consumer.ConsumerUtils.createQueueConsumer;
